...
import 'package:gulapedia/src/widgets/form_fields/activities_field.dart';
import 'package:gulapedia/src/widgets/form_fields/birthday_field.dart';
import 'package:gulapedia/src/widgets/form_fields/gender_field.dart';
import 'package:gulapedia/src/widgets/form_fields/number_field.dart';
    ...
    return BlocProvider<SignUpBloc>(
      ...
      child: BlocConsumer<SignUpBloc, SignUpState>(
        listener: (context, state) {
          if (state.isSuccess) {
            context.go(AppRoutes.catatanHarian);
